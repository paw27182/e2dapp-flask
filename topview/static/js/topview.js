...
$(function () {
    $('.dropdown-item').off().on("click", function () {
        ...
        if (dropdown_menu == "Entry") {
            ...
            $('#area4Request #area1').load("appmain/static/html/inquire.html");
            ...
            $('#area4Request #area1').load("appml/static/html/inquire_appml.html");
            $("#area4Result").empty();  // clear result area
            ...
            if (dropdown_item == "FAQ") {
                $('#area4Result').load("topview/static/html/faq.html");
...
$(function () {
    $('.btn_faqlanguage').off().on("click", function () {
        $('#area4Result').load("topview/static/html/faq_j.html");
        $('#area4Result').show();
